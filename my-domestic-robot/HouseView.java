...
public class HouseView extends GridWorldView {                              
    ...
    public void draw(Graphics g, int x, int y, int object) {
        ...
        case HouseModel.OWNER:
            ...
            break;
		case HouseModel.LIGHTS:
            if (lRobot.equals(hmodel.lLights)) {
                super.drawAgent(g, x, y, Color.yellow, -1);
            }
			if ((hmodel.lightsOn)) {
            ...
            drawString(g, x, y, defaultFont, "LAMP");//drawString(g, x, y, defaultFont, "LAMP ("+hmodel.timeView+")");
            break;
        }
        repaint();
    }
    ...
    public void drawAgent(Graphics g, int x, int y, Color c, int id) {
        Location lRobot = hmodel.getAgPos(0);
        if (!lRobot.equals(hmodel.lOwner) && !lRobot.equals(hmodel.lFridge) && !lRobot.equals(hmodel.lLights)) {
            c = Color.yellow;
